  ...
  <ZeroFormField
    ...
    <label v-if="scaffold.label" :for="fieldId" :class="['field-label', state]">
      <div class="panel-left">
        <ZeroKitchenSinkFieldIconInProgress class="icon in-progress" />
        <ZeroKitchenSinkFieldIconComplete class="icon completed" />
        <ZeroKitchenSinkFieldIconError class="icon error" />
        <span class="text">
          {{ scaffold.label }}
