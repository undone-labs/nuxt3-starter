<template>
  <main class="page">
    ...
    <template v-if="!runtimeConfig.public.algolia.disable">
...
<script setup>
// ======================================================================== Data
const { data: content } = await useAsyncData('algolia-content', () => {
  return queryContent({
    where: {
      _path: { $contains: '/zero-ui/algolia-intro' }
    }
  }).find()
})
